    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card
        className={cn(
          ...
          isRedirecting &&
            "scale-[0.985] shadow-[0_40px_100px_-45px_rgba(14,165,233,0.5)]",
        )}
      >
        <CardContent className="grid p-0 md:grid-cols-2">
          <form
            className={cn(
              ...
              isRedirecting &&
                "pointer-events-none scale-[0.985] opacity-40 blur-[1px]",
            )}
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
        ...
        <div>
          <a
            className="inline-block no-underline h-[20px] leading-[20px]"
            href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44060602002491"
            rel="noreferrer"
            target="_blank"
          >
            <p className="float-left h-[20px] leading-[20px] m-0 ml-[5px]">
              粤公网安备 44060602002491号
            </p>
          </a>
        </div>
      </div>
