...
export function LeftSidebar({
  ...
  const platformMenus = JSON.parse(
    JSON.stringify(
      snap.pageDomain.home.uiDomain.layout.leftSidebar.menu.platform,
    ),
  );
  const projectMenus = JSON.parse(
    JSON.stringify(
      snap.pageDomain.home.uiDomain.layout.leftSidebar.menu.project,
    ),
  );
