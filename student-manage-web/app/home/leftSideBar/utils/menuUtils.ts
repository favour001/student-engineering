...
const builtInBusinessMenus: MenuItem[] = [
  {
    ...
    children: [
      ...
      },
      {
        id: -102,
        name: "协会介绍",
        code: "association-intro",
        type: 2,
        category: 2,
        status: 0,
        icon: "association-intro",
        path: "/business/association-intro",
        sortNumber: 2,
        parentId: -100,
      },
      {
      ...
      },
      {
        id: -106,
        name: "留创顺德",
        code: "innovation-shunde",
        type: 2,
        category: 2,
        status: 0,
        icon: "innovation-shunde",
        path: "/business/innovation-shunde",
        sortNumber: 6,
        parentId: -100,
      },
      {
        id: -107,
        name: "留学资讯",
        code: "study-abroad-news",
        type: 2,
        category: 2,
        status: 0,
        icon: "study-abroad-news",
        path: "/business/study-abroad-news",
        sortNumber: 7,
        parentId: -100,
      },
      {
      ...
      },
      {
        id: -109,
        name: "服务平台",
        code: "service-platform",
        type: 2,
        category: 2,
        status: 0,
        icon: "service-platform",
        path: "/business/service-platform",
        sortNumber: 9,
        parentId: -100,
      },
      {
 ...
 * @returns 过滤后的菜单数组
 */
export const filterMenusByType = (
  menus: MenuItem[],
  types: number[],
): MenuItem[] => {
