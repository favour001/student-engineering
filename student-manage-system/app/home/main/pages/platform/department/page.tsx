...
export default function DepartmentManagePage() {
  ...
  const handleView = (_department: DepartmentData) => {};
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      parentId:
        ...
        (formState.parentId as any) === "none"
          ? null
      ...
      case "name":
        return (
          <div
            ...
            style={{ paddingLeft: `${((item as any).depth || 0) * 1.5}rem` }}
          >
            {((item as any).depth || 0) > 0 && (
        ...
        <ModalContent>
          ...
          <ModalBody className="grid gap-4 md:grid-cols-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormState((prev) => ({ ...prev, leader: e.target.value }))
              }
            />
            <Input
              label="联系电话"
            ...
            <Select
              label="上级部门"
              selectedKeys={
                formState.parentId ? [String(formState.parentId)] : []
              }
